      ...
      <div className={styles['card']}>
        ...
        >
          {oldPrice && (
            <span className={styles['discount']}>
              {Math.round((1 - props.price / oldPrice) * 100)}% off
            </span>
          )}
        ...
        <div className={styles['footer']}>
          ...
          <div className={styles['price']}>
            <span className={styles['current-price']}>{formattedPrice}</span>
            {formattedOldPrice !== null && (
              <span className={styles['old-price']}>{formattedOldPrice}</span>
            )}
          </div>
        </div>
      </div>
